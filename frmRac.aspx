<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="frmRac.aspx.cs" Inherits="WebSGQ.frmRac" %>
    ...
    <div class="accountInfo" style="width: 770px; margin-bottom: 0px;margin: auto">
        ...
        <fieldset class="box" style="color: #87929f; margin-bottom: 0px">
                ...
                <tr style="width: 700px">
                    ...
                    <td style="width: 300px">
                        <asp:DropDownList ID="cbomod" Class="textBox" Width="200px" runat="server">
                            ...
                            <asp:ListItem Text="NC Auditoria" Value="1" />
                            <asp:ListItem Text="NC Fornecedor" Value="2" />
                            <asp:ListItem Text="NC Processo" Value="3" />
                            <asp:ListItem Text="Reclamação de Cliente" Value="4" />
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
            <table>
                <tr style="width: 700px">
                    <td style="width: 100px">
                        <asp:Label ID="lblhis" runat="server" class="label">Histórico do Problema</asp:Label>
                    </td>
                    <td style="width: 300px">
                        <asp:TextBox ID="txthis" class="textBox" TextMode="MultiLine" runat="server" Rows="4" Width="554px" OnTextChanged="txthis_TextChanged"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <table>
                <tr style="width: 700px">
                    <td style="width: 100px">
                        <asp:Label ID="lbldis" runat="server" class="label">Disposição</asp:Label>
                    </td>
                    <td style="width: 300px">
                        <asp:TextBox ID="txtdis" class="textBox" TextMode="MultiLine" runat="server" Rows="4" Width="554px"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <table>
                <tr style="width: 700px">
                    <td style="width: 100px">
                        <asp:Label ID="lblrespdis" class="label" runat="server">Resp. Disposição</asp:Label>
                    </td>
                    <td style="width: 300px">
                        <asp:TextBox ID="txtrespdis" runat="server" AutoPostBack="true" CssClass="textBox" Width="300px"></asp:TextBox>
            ...
            <table>
                <tr style="width: 700px">
                    <td style="width: 100px">
                        <asp:Label ID="lbldatdis" runat="server" class="label" AssociatedControlID="txtdatdis">Data Disposição</asp:Label>
                    </td>
                    <td style="width: 100px">
                        <asp:TextBox ID="txtdatdis" runat="server" class="textBox" Width="100px"></asp:TextBox>
                        <asp:CalendarExtender ID="CalendarExtender2" TargetControlID="txtdatdis" Animated="true"
                            Format="dd/MM/yyyy" runat="server"/>
                    </td>
                </tr>
