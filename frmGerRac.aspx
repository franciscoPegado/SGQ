<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="frmGerRac.aspx.cs"
    Inherits="WebSGQ.frmGerRac" %>
            ...
            <table>
                <tr style="width: 700px">
                    <td style="width: 100px">
                        <asp:Label ID="lbldataber" runat="server" class="label">N° RAC</asp:Label>
                    </td>
                    <td style="width: 100px">
        ...
        <fieldset class="box" style="color: #87929f; margin-bottom: 0px">
            <table id="tblGrdData" runat="server" visible="true">
                <tr style="width: 900px">
                    <td style="width: 100px">
                        <asp:GridView ID="grdRac" runat="server" AllowPaging="True" AllowSorting="True" CellPadding="13"
                            Width="830px" OnRowDataBound="grdRac_RowDataBound" PageSize="100" ForeColor="#333333"
                            GridLines="None" Font-Names="Verdana" Font-Size="10px" 
                            onselectedindexchanged="grdRac_SelectedIndexChanged">
